...
let random = getRandomInt(starWarsCharacters.length);
/*
let perFrase = [starWarsCharacters[random].name, starWarsCharacters[random].birth_year, starWarsCharacters[random].eye_color,
starWarsCharacters[random].gender, starWarsCharacters[random].hair_color, starWarsCharacters[random].height,
starWarsCharacters[random].mass, starWarsCharacters[random].skin_color]; */

console.log(starWarsCharacters[random].name + ' nato nel ' + starWarsCharacters[random].birth_year + ' alto ' + 
    starWarsCharacters[random].height + ' con i capelli di colore ' + starWarsCharacters[random].hair_color + ' con un peso di ' + 
